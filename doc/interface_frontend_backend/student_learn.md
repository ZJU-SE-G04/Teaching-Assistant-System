...
|s5|获取所有课件资料     | get_courseware.php?courseID=xxx         |无            |[{"courseware_name":"xxx", "courseware_id":"xxx", "courseware_kind":"xxx"}, {"courseware_name":"xxx", "courseware_id":"xxx", "course_kind":"xxx"}]|无
...
|s9|获取某个一级回复的所有二级回复|posts_handler.php?action=fetchReRe&topic_id=xxx&floor=xxx        |无| [{"userid":"xxx", "username":"xxx","username_of_be_re":"xxx","id_of_be_re":"xxx", "floor_be_re": 0, "re_content":"xxxxxx", "re_time":"xxx", "re_floor": 1}, ...]|floor_of_be_re为0表示回复对象是一级回复的楼主
|s10|发表主题帖                  |posts_handler.php?action=submitPost                |border_type=0&title=xxx&content=xxx&course_id=xxx    | { "state": 0, "msg": "xxx" }  | state为0表示发表成功，为1表示发表失败
...
|s15|用户有没有登录            |check_if_login.php|无| { "login": 1, "msg":"xxxxxx" } | login为1表示已经登录，为0表示未登录
|s16|向后端请求下载课件         |download_courseware.php?courseware_id=5             |无|||
###选择测试或实验报告
<table>
    <thead>
    <tr>
