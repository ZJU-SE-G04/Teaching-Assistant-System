...
|发布文章|add_article.php?lesson_id=xxx&id=xxx&title=xxx&content=xxx&datetime=xxx|删除成功：{"if_success":1,error_message:"null"};删除失败：{"if_success":0,"error_messgae":"xxx"}|成功或失败返回的是整数1或0|否
