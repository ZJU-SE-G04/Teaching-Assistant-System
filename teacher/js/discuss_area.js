/**
 * Created by dddong on 16/12/21.
 */


var POSTNUM_PER_PAGE = 10;
var POSTRE_NUM_PER_PAGE = 10;
...
$(document).ready(function () {
    ...
    function get_post_re_num() {
        var topic_id = $("#discuss_post_detail_page .post-detail").attr("topic_id");
        var num;
        $.ajax({
    ...
    function fetch_post_re(post_id, offset, count) {
        $.ajax({
            ...
            success: function (results) {
                ...
                $("#discuss_post_detail_page .pagination").children().remove();
                var pagination = $("#discuss_post_detail_page .pagination").append($("<li><a>&laquo;</a></li>"));
                ...
                $("#discuss_post_detail_page .pagination>li:nth-child(" + (cur_page_num+1) +")").addClass("active");

                $("#discuss_post_detail_page .pagination>li>a").click(function () {
                    var topic_id = $("#discuss_post_detail_page .post-detail").attr("topic_id");
                    if ($(this).text() == "«") {
